...
MErr = 0.1 #+/- 10 CI, the desired level of precision (i.e. the margin of error),
...
#    So p = 0.5. Now let’s say we want 80% confidence, and at least 10 percent—plus
#    or minus—precision. A 80 % confidence level gives us Z values of 1.28, 
#    per the normal tables, so we get
#  
#    ((1.28)2 (0.5) (0.5)) / (0.1)2 = 41.
